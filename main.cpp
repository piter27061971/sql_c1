...
public:
    ...
    {
        std::string create3,create1;
        int id1;
        pqxx::transaction tx3{ connection1 };
        create3 = "INSERT INTO person(first_name, last_name, e_mail) VALUES('tx3.esc(" + firstName + ")' , 'tx3.esc(" + lastName + ")' , 'tx3.esc(" + email + ")');";
        create1 = "select id from person where ((first_name='tx3.esc("
            "" + firstName + ")') and (last_name ='tx3.esc("
            "" + lastName + ")') and (e_mail ='tx3.esc("
            "" + email + ")')); ";
    ...
    void addPhoneNumber(int clientId, const std::string& phoneNumber)
    {
        ...
        std::string create2;
        pqxx::work tx1{ connection1 };
        create2 = "INSERT INTO telefon (id_person, telefon) values ('tx1.esc(" + std::to_string(clientId) + ")','tx1.esc(" + phoneNumber + ")');";
    ...
    {
        std::string create1 = "update person set first_name = 'tx1.esc(" + firstName + ")', last_name ='tx1.esc(" + lastName + ")', e_mail = 'tx1.esc(" + email + ")' "
            "where ((id='tx1.esc("
    ...
    {
        std::string create2, create3;
        pqxx::work tx1{ connection1 };
        create2 = "delete from telefon where (id_person='tx1.esc(" + std::to_string(clientId) + ")');";
        create3 = "delete from person where (id='tx1.esc(" + std::to_string(clientId) + ")');";
    ...
    {
        std::string create1 = "delete from telefon where (telefon='tx1.esc(" + telefon1 + ")');";       
            pqxx::work tx1{ connection1 };
    ...
    {
        std::string create1 = "select id from person where ((first_name='tx1.esc("
            "" + first_name1 + ")') and (last_name ='tx1.esc("
    ...
    {
        int id1;
        std::string create1 = "select id_person from telefon where (telefon='tx1.esc(" + telefon1 + ")');";
